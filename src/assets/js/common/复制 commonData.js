...
//拖拽图片类
class DragImg extends CommonDrag{
  constructor({
    refs,
    IsEquipment
  }) {
...
//公共数据
class CommonDrag {
  constructor(refs='', IsEquipment=false,equiTabData={},ProjectId='',get_equipment_data=[]) {
  	this.refs=refs;
...
class DragLabel extends CommonDrag {
  constructor({
    ...
    console.log('vm.eqInfo:', this.eqInfo);
//  this.refs = refs;
//  this.ProjectId = ProjectId;
...
class DragChart extends CommonDrag {
  constructor({
    ...
    super(refs, IsEquipment,equiTabData,ProjectId,get_equipment_data);
//  this.refs = refs;
//  this.ProjectId = ProjectId;
//  this.get_equipment_data = get_equipment_data;

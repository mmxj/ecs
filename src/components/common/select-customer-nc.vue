<template>
	<span class="input-group">
		<input v-model="CustomerName" id="txtCustomerName" type="text" maxlength="100" class="form-control required" data-valid="isNonEmpty" data-error="客户名称不能为空" placeholder="请选择客户"  disabled="disabled" />
		...
		<div id="modal-cleosCompany" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="display: none;">
            <div class="modal-content">
            	<div class="modal-header">
            	    ...
            	    <button id="btnSave" type="button" class="sava" data-dismiss="modal" aria-hidden="true" v-on:click="get_tempUser()"><i class='fa fa-save m-r-5'></i>确定</button>
            	    <h4 class="modal-title">选择客户</h4>
            	</div>
                <div class="modal-body nicescroll">
                	<div>
                	    <span class="OrgTopAligin">
                	        <input id="customerSearchTxt" v-model.trim="customerSerach" class="form-control" placeholder="客户编号/客户名称" type="text">
                	    </span>
                	    <span class="OrgTopAligin">
	...
	export default{
	    ...
	    methods: {
	        ...
	        newGetData: function (){
        	    ...
        	    this.customerSerach = '';
    	    	this.CustomerName = $("#txtCustomerName").val();

	...
	<div>
        <div class="col-lg-3 col-xs-4">
            <span class="input-group">
                <input v-model="txtContact" id="txtContactName" class="form-control required" type="text" data-valid="isNonEmpty" data-error="设备名称不能为空" value="" readonly placeholder="请选择设备" disabled="disabled">
        ...
        <div id="modal-contact" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">选择设备名称</h4>
                </div>
                <div id="verifyCheck">
                    <div id="modal_body1" class="modal-body nicescroll">
                        <div class="">
                            <span class="OrgTopAligin">
                                <input id="getwaySearchTxt" v-model.trim="contactNameSerach" class="form-control" placeholder="设备名称" type="text">
                            </span>
                            <span class="OrgTopAligin">
...
//                        "Keywords": this.contactNameSerach
        ...
        mounted: function() {
            var _this = this;
            this.getData();
            $('#getwaySearchTxt').bind('keypress',function(event){
                if(event.keyCode == "13"){
                    _this.getData();
                }
            });

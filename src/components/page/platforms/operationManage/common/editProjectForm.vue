...
import wb_info from 'components/page/maintenanceAgent/items/subComponents/project/wb_info.vue'
import charger_info from 'components/page/maintenanceAgent/items/subComponents/project/charger_info.vue'
import code_info from 'components/page/maintenanceAgent/items/subComponents/project/code_info.vue'
import visible_info from 'components/page/maintenanceAgent/items/subComponents/project/visible_info.vue'
...
export default {
		...
		QueryDetail:function(){
            ...
            eosCommon.eosAjax(url, "GET", param, "json", function(result) {
                if(eosCommon.checkCode(result.State, result.Message)) {
                	_this.noData=false;
                	// console.log("api/project/QueryDetail 返回的数据:", result.Data)
	...
	mounted:function(){
		...
		_this.itemInfo=_this.editFormData;

  ...
  <div class="tableWrap" v-loading="loading">
    ...
    <div style="height: calc(100% - 100px);overflow: auto">
      <el-table :data="tableData" style="width: 100%" class='userTable' stripe>
        ...
        <el-table-column prop="ActivityContent" label="活动描述" align='center'></el-table-column>
        <el-table-column prop="UserName" label="操作人员" align='center'></el-table-column>
        <el-table-column prop="ActivityTime" label="时间" align='center'></el-table-column>
      </el-table>
    </div>
    <div class="pagin">
      <div class="pageDes">
...
export default {
  ...
  methods: {
    ...
    tableLoad(PageSize = this.PageSize,
      ...
      let url = URL.QUERYPROJECTACTIVITYLOG
      GET(url, params)
        .then(function(response) {
          let res = response.data
          if (FUNC.checkCode(res.State, res.Message)) {

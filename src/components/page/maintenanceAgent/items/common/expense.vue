<template>
	<div id="expense-box">
		<div class="row">
			<div class="col-sm-12">
				...
				<div id="divDataTableView" class="card-box table-responsive" style="display: none">
					...
					<div class="row mb-10">
						<div class="col-lg-12">
							...
							<span class="OrgTopAligin">
		                                <input id="txtQueryKeywords" type="text" class="form-control" placeholder="项目名称/项目编号">
		                            </span>
							<span class="OrgTopAligin">
					...
					<div class="row mt-10" style="margin-top: 20px">
						<table id="example_ex" class="table table-striped table-bordered" width="100%">
							<thead>
								<tr>
									<th>序号</th>
									<th>工号</th>
				...
				<div id="costTotalList" class="card-box table-responsive">
					...
					<div class="row">
						<div class="col-md-12">
							<span class="size20 font-bold">费用列表</span>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<span class="OperatorSearch">
								<span class="OrgTopAligin">
                                	<input id="txtQueryCost" name="txtAccount" class="EosAutocompleter form-control autocompleter-node" placeholder="项目编号/项目名称" autocomplete="off" type="text">
                            	</span>
								<span class="OrgTopAliginTime">
		                            ...
		                            <input id="txtStartDateCost" class="form-control" size="16" value="" readonly="" placeholder="开始时间" type="text">
		                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
									</span>
							</span>
							<span class="OrgTopAliginTime">
                                ...
                                <input id="txtEndDateCost" class="form-control" size="16" value="" readonly="" placeholder="结束时间" type="text">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
							</span>
							</span>
							<span class="OrgTopAligin">
							...
							<table id="EmployeeCostDetail" class="table table-striped table-bordered" width="100%">
								<thead>
									<tr role="row">
				...
				<div id="costTotalAdd" class="card-box table-responsive" style="display: none">
					<div class="row">
						<div class="col-sm-6 col-md-4 col-lg-6">
							<label class="size20 font-bold">添加费用</label>
						</div>
						<div class="col-sm-6 col-md-4 col-lg-6">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-xs-12">
							<div class="alert alert-dismissable eos-text-warning">
								<strong>温馨提示：</strong> 请认真填写费用各项信息，认真比对之后方可提交，一经提交的费用 资料，不可以再修改与删除！
							</div>
							<div class="">
								<div id="verifyCheck">
									<div class="form-horizontal content-box mt-0">
										<div class="form-group">
											...
											<!--<div class="col-lg-6 col-xs-9">
												<select-employee :propsdata="propsEmployeedata"></select-employee>
											</div>-->
										</div>
										<div class="form-group">
										...
										<div class="col-lg-2 col-xs-3" v-show="!propsData.ProjectId">
									...
									<div class="form-group">
										...
										<div class="col-lg-6 col-xs-9">
											...
											<input id="txtCost" type="text" class="form-control required" data-valid="isNonEmpty||isPrice" data-error="金额不能为空||金额格式不对" placeholder="金额(单位：元)" maxlength="20" />
											<span class="ion-close-circled close hide text-danger valid-input-icon"></span>
											<label class="fa fa-check-circle blank hide text-success valid-input-icon"></label>
										</div>
									</div>
								...
								<div class="form-horizontal content-box ">
									<div class="form-group">
										...
										<div class="col-lg-6 col-xs-9">
											...
											<textarea id="txtUsage" maxlength="100" class="form-control required" data-valid="isNonEmpty" data-error="费用用途不能为空" placeholder="费用用途"></textarea>
											<span class="ion-close-circled close hide text-danger valid-input-icon"></span>
											<label class="fa fa-check-circle blank hide text-success valid-input-icon"></label>
										</div>
									</div>
								...
								<div class="content-box-footer">
									<div class="form-group">
										...
										<div class="col-lg-5 col-xs-8 pl-22">
											<button type="button" class="btnReturn btn btn-white pull-left mr-20" v-on:click="btnReturnView()">取消</button>
											<button id="btnAddEdit" type="submit" class="btn btn-default pull-left loading_btn" v-on:click="btnSaveExpense()" data-loading-text="保存中...">确定</button>
										</div>
									</div>
								</div>
							</div>
			...
			<!--添加费用列表——结束-->
			<!--查看费用详情——开始-->
			<div id="costTotalView" class="card-box table-responsive" style="display: none">
				<div class="row">
					<div class="col-sm-12">
						<label class="size20 font-bold">查看详情</label>
						<label class="pull-right">
                                 <button id="cancelBtn" type="submit" class="btn btn-white pull-right"><i class="fa fa-mail-reply-all m-r-5"></i>返回</button>
                             </label>
					</div>
				</div>
				<hr class="divider mt-10">
						...
						<div class="mt-15">
							<div>
								<div class="form-horizontal mt-10 content-box">
									<div class="form-group">
										<label class="content-title-left text-right">员工姓名</label>
									...
									<hr class="divider">
									<div class="form-group">
										<label class="content-title-left text-right">费用类型</label>
										<div class="content-title-right">
									...
									<hr class="divider">
									<div class="form-group">
										<label class="content-title-left text-right">消费日期</label>
										<div class="content-title-right">
											<div id="viewDate"></div>
										</div>
									</div>
									<hr class="divider">
									<div class="form-group">
										<label class="content-title-left text-right">费用归属项目</label>
										<div class="content-title-right">
									...
									<hr class="divider">
									<div class="form-group">
										<label class="content-title-left text-right">金额</label>
										<div class="content-title-right">
									...
									<hr class="divider">
									<div class="form-group">
										<label class="content-title-left text-right">费用用途</label>
										<div class="content-title-right">
											<div id="viewPriceUser"></div>
										</div>
									</div>
									<hr class="divider">
									<div class="form-group">
										<label class="content-title-left text-right">发票</label>
										<div class="content-title-right">
											<div id="viewImg"></div>
										</div>
									</div>
	...
	export default {
		...
		methods: {
			bind_DateTime: function() {
				$('#txtStartDateCost').val(eosCommon.getTime("yyyy-MM-dd", -(new Date().getDate() - 1)));
				$('#txtEndDateCost').val(eosCommon.getTime("yyyy-MM-dd", 0));
				$('#txtStartDate').val(eosCommon.getTime("yyyy-MM-dd", -(new Date().getDate() - 1)));
				$('#txtEndDate').val(eosCommon.getTime("yyyy-MM-dd", 0));
			},
			bind_EmployeeCostTilte: function() {
				...
				var param = {
					...
					"Parameters": {
						...
						"StartDate": $('#txtStartDateCost').val(),
						"EndDate": $('#txtEndDateCost').val()
					}
				};
				var url = eosCommon.ENTERPRISE_API + "api/project/queryexpense";
				eosCommon.eosAjax(url, "GET", param, "json", function(result) {
					if(eosCommon.checkCode(result.State, result.Message)) {

						if(result.Data != "") {
							for(var key in result.Data.Tilte) {
								$("#EmployeeCostDetail tr").append("<th>" + result.Data.Tilte[key] + "</th>");
								ininDataColums.push({ data: result.Data.Tilte[key] })
							}

							var jobNum = result.Data.Tilte['项目编号'];
							...
							_this.bind_EmployeeCostDetail(ininDataColums, ininDataColumnDefs);
							//_this.load_view();							
			...
			bind_EmployeeCostDetail: function(ininDataColums, ininDataColumnDefs) {
				var _this = this;
				export_col = [];
				...
				CostDetail = $('#EmployeeCostDetail').DataTable({
				...
				$('#EmployeeCostDetail tbody').on('click', 'tr', function() {
				...
				$('#EmployeeCostDetail tbody').on('click', 'span', function() { //黄
					var data = CostDetail.rows($(this).parents('tr')).data();
					for(var key in data[0]) {
						if(data[0][key] == $(this).text()) {
							if(key == '项目名称' || key == '合计' || key == '项目编号') {
								
								_this.isFilter = false;
								_this.detail_info_click(data);

							} else {
								_this.isFilter = true;
								_this.nowKeyWords = key; //当前关键字
			...
			detail_info_click: function(data) {
				$('#txtStartDate').val($('#txtStartDateCost').val());
				$('#txtEndDate').val($('#txtEndDateCost').val());
				$('#txtQueryKeywords').val(data[0]['项目编号']);
				table.ajax.reload();
				$('#costTotalList').hide();
...
//				alert('11');
				table = $('#example_ex').DataTable({
					...
					ajax: function(data, callback, settings) {
						...
						var url = eosCommon.ENTERPRISE_API + "api/project/queryexpense2";
						eosCommon.eosAjax(url, "GET", param, "json", function(result) {
							
							if(eosCommon.checkCode(result.State, result.Message)) {
								if(!_this.isFilter) { //直接用接口返回数据
									var returnData = {};
									if(result.Data == "") {
										returnData.draw = data.draw;
										returnData.recordsTotal = 0;
									...
									if(result.Data == "") {
										...
										for(var key in result.Data.Result) {
											if(result.Data.Result[key].ExpenseItemName == _this.nowKeyWords) {
												myResult.Data.Result.push(result.Data.Result[key]);
											}
										}
										myResult.Data.Total = myResult.Data.Result.length;
										returnData.draw = data.draw;
										returnData.recordsTotal = myResult.Data.Total;
										returnData.recordsFiltered = myResult.Data.Total;
										returnData.data = myResult.Data.Result;
					...
					"columns": [
						...
						{ data: "CostDate" },
						{ data: "ProjectName" },
						{ "defaultContent": "<span class='cursor' title='查看详情'><i class='fa fa-eye'></i></span>" }
					]
				});
				...
				$('#example_ex tbody').on('click', 'tr', function() {
					if($(this).hasClass('selected')) {
						$(this).removeClass('selected');
					} else {
				...
				$('#example_ex tbody').on('click', 'span', function() {
			...
			is_Other: function(selName) {
				if(selName == "其它") {
					...
					$('#txtOtherExpenseName').attr("data-error", "费用说明不能为空||费用说明长度为25位");
				} else {
			...
			bind_AddEditCostView: function(data) {
				...
				if(data == null) {
					...
					$('#hidUserId').val(data[0].EmployeeId);
			...
			bind_view_info: function(data) {
				$('#viewName').html(data[0].UserName);
				$('#viewProject').html(data[0].ProjectName);
				$("#viewClass").html(data[0].ExpenseItemName);
				$('#viewDate').html(data[0].CostDate);
				$('#viewPrice').html(data[0].Cost);
				$('#viewPriceUser').html(data[0].Usage);
				if(data[0].Attachments[0]) {

					for(var i = 0; i < data[0].Attachments.length; i++) {

						$('#viewImg').append('<img style="width: 100px;" src="' + data[0].Attachments[i].ResourceUrl + '">');
			...
			addRequest: function(Attachments) {
				...
				if(_this.propsData.ProjectId) {
					...
					_this.initProjectId = $('#hidProjectId').val()
				}
				var param = {
					"AccessToken": eosCommon.storage.get("AccessToken"),
					"Parameters": {
				...
				var url = eosCommon.ENTERPRISE_API + "api/project/insertexpense";
			...
			addEditCost: function(data) {
				...
				$('#divDataTableView').hide();
				$('#costTotalAdd').show();
				$("#costTotalAdd").getNiceScroll().resize();
		...
		mounted: function() {
			...
			$("#costTotalAdd,#costTotalList").getNiceScroll().resize();
			...
			$('#EndDateCost').datetimepicker('setStartDate', $("#txtStartDateCost").val());
			$('#StartDateCost').datetimepicker('setEndDate', $('#txtEndDateCost').val());
			$("#txtStartDateCost").change(function() {
				$('#EndDateCost').datetimepicker('setStartDate', $(this).val());
			});
			$("#txtEndDateCost").change(function() {
			...
			_this.bind_DateTime();
			_this.bind_EmployeeCostTilte();											
			_this.load_view();
			this.bind_ExpenseItem();
			if(_this.propsData.ProjectName != "") {
				$("#txtQueryCost,#txtQueryKeywords").val(_this.propsData.ProjectName).hide();
			};

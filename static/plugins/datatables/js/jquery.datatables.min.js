    ...
    var S = function (g) {
        ...
        function nb(a) {
            var b = a.oClasses, c = g(a.nTable), c = g("<div/>").insertBefore(c),
                e = a.oFeatures, d = g("<div/>", {id: a.sTableId + "_wrapper", "class": b.sWrapper + (a.nTFoot ? "" : " " + b.sNoFooter)});
            a.nHolding = c[0];
            a.nTableWrapper = d[0];
        ...
        function pb(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage,
                d = a.oPreviousSearch, f = a.aanFeatures, h = '<!--<div class="menu-info-block"><div class="right"><div class="search-block"><div class="form-input-icon form-input-icon-right"><i class="fa fa-search"></i><input type="search" class="form-control input-sm form-control-rounded"><button type="submit" class="search-block-submit"></button></div></div></div></div>-->', i = e.sSearch, i = i.match(/_INPUT_/) ? i.replace("_INPUT_", h) : i + h, b = g("<div/>", {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: {sFirst: "首页", sLast: "最后页", sNext: "下一页", sPrevious: "上一页"},
                sEmptyTable: "暂无数据",

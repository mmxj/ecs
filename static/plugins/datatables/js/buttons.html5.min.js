(function ( g ) {
    ...
    l.ext.buttons.copyHtml5 = {
        className       : "btn-default buttons-copy buttons-html5",
        text            : function ( a ) {
    ...
    l.ext.buttons.excelHtml5 = {
        className  : "btn-default buttons-excel buttons-html5", available: function () {
    ...
    l.ext.buttons.pdfHtml5 = {
        className: "btn-default buttons-pdf buttons-html5", available: function () {

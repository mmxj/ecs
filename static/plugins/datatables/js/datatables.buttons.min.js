/*!
 ...
 ©2015 SpryMedia Ltd - eos/license
 */
(function (e) {
    "function" === typeof define && define.amd ? define(["jquery", "eos"], function (n) {
        return e(n, window, document)
    }) : "object" === typeof exports ? module.exports = function (n, o) {
        n || (n = window);
        if (!o || !o.fn.dataTable)o = require("eos")(n, o).$;
                ...
                if (h)if (e.isArray(h))this._buildButtons(h, b, c); else {
                    ...
                    if (i) {
                        ...
                        c === m ? (this.s.buttons.push({
                            node: q, conf: h,
                            inserter: i.inserter
                        }), this.s.subButtons.push([])) : this.s.subButtons[c].push({node: q, conf: h, inserter: i.inserter});
    ...
    l.defaults = {
        ...
        tabIndex: 0,
        dom: {
            container: {tag: "div", className: "dt-buttonssss"},
            collection: {tag: "div", className: "dt-button-collection"},
            button: {tag: "a", className: "dt-button", active: "active", disabled: "disabled"},
            buttonEx: {tag: "a", className: "dt-button", active: "active", disabled: "disabled"},
            buttonLiner: {tag: "", className: ""}
        }
    };
    l.version = "1.1.0";
    e.extend(k, {
        collection: {
            text: function (a) {
                return a.i18n("")
            }, className: "btn-whiteEx font-16", action: function (a, b, c, d) {
                ...
                f && "absolute" === g ? d._collection.css({top: f.top + 5, left: f.left + 5}) : "absolute" === g ? (d._collection.css({

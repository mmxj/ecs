        ...
        handleSidebarScroll: function () {
            ...
            function checkHeightSidebar() {
                ...
                if($('.page-sidebar-fixed').length){
                    ...
                    var heightSidebarLeft       = $(window).outerHeight() - $('#header').outerHeight() - $('.sidebar-content').outerHeight();
                    $('#EcosIndexTree').height(heightSidebarLeft)
                        .niceScroll({
                            railalign: 'left',
                            cursorwidth: "5px",
                            cursoropacitymax:0.8,
                            cursorborder: "0px solid #fff",
                            railpadding: { top: 0, right: 0, left: 3, bottom: 0 },
                        });
                }
